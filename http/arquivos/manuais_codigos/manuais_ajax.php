...
<div class="conteudo" id="table dados"><br>
  ...
  <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr class="td_odd" onmouseout="style.background='#F0F0F0'" onmouseover="style.background='#DDE1E6'">
      ...
      <td width="230" align="center"><a href="arquivos/manuais_codigos/files/cid.pdf" target="_blank"><img src="imagens/icones/visualizar.png" alt="Ver arquivo" width="16" height="20" border="0" /></a></td>
    </tr>
    <tr class="td_even" onmouseout="style.background='#F8F8F8'" onmouseover="style.background='#DDE1E6'">
      ...
      <td align="center"><a href="arquivos/manuais_codigos/files/codigo_etica.pdf" target="_blank"><img src="imagens/icones/visualizar.png" alt="Ver arquivo" width="16" height="20" border="0" /></a></td>
    </tr>
    <tr class="td_odd" onmouseout="style.background='#F0F0F0'" onmouseover="style.background='#DDE1E6'">
      <td height="23" align="left">C&oacute;digo de Processo &Eacute;tico - CFO<br /></td>
      <td align="center"><a href="arquivos/manuais_codigos/files/codigo_proc_etico.pdf" target="_blank"><img src="imagens/icones/visualizar.png" alt="Ver arquivo" width="16" height="20" border="0" /></a></td>
    </tr>
    <tr class="td_even" onmouseout="style.background='#F8F8F8'" onmouseover="style.background='#DDE1E6'">
      <td height="23" align="left">Manual de Biosseguran&ccedil;a - CFO<br /></td>
      <td align="center"><a href="arquivos/manuais_codigos/files/manual_biosseguranca.pdf" target="_blank"><img src="imagens/icones/visualizar.png" alt="Ver arquivo" width="16" height="20" border="0" /></a></td>
    </tr>
    <tr class="td_odd" onmouseout="style.background='#F0F0F0'" onmouseover="style.background='#DDE1E6'">
      <td height="23" align="left">Manual de Gerenciamento de Res&iacute;duos - ANVISA<br /></td>
      <td align="center"><a href="arquivos/manuais_codigos/files/manual_gerenciamento_residuos_anvisa.pdf" target="_blank"><img src="imagens/icones/visualizar.png" alt="Ver arquivo" width="16" height="20" border="0" /></a></td>
    </tr>
    <tr class="td_even" onmouseout="style.background='#F8F8F8'" onmouseover="style.background='#DDE1E6'">
      <td height="23" align="left">Manual da Odontologia - ANVISA</td>
      <td align="center"><a href="arquivos/manuais_codigos/files/manual_odonto_anvisa.pdf" target="_blank"><img src="imagens/icones/visualizar.png" alt="Ver arquivo" width="16" height="20" border="0" /></a></td>
    </tr>
  </table>
</div>
