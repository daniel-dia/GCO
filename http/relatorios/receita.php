...
?>
<br />
<div align="center"><font size="4"><b><?php echo $LANG['reports']['recipe']?></b></font></div><br /><br />
...
?>
<div align="center">
<form action="receita.php?codigo=<?php echo $_GET['codigo']?>" method="POST">
<textarea name="receita" class="forms" cols="130" rows="30"><?php echo $receita->Receita?></textarea><br />
<br />
