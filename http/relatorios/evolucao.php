...
?>
<font size="3"><?php echo $LANG['reports']['treatment_evolution_of']?> <b><?php echo $row['nome']?> [<?php echo $_GET['codigo']?>]</b></font><br /><br />
...
?>
  <tr class="<?php echo $td_class?>" style="font-size: 12px">
    <td><?php echo $row['executado']?>
    </td>
    <td><?php echo $row['previsto']?>
    </td>
