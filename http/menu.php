...
<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-file" aria-hidden="true"></span> <?php echo $LANG['menu']['file']?><span class="caret"></span></a>
            ...
            <li><a href="#" data-toggle="dropdown"><span class="glyphicon glyphicon-usd" aria-hidden="true"></span> <?php echo $LANG['menu']['monetary']?><span class="caret"></span></a>
                  <ul  class="dropdown-menu">
            ...
            <li><a href="#" data-toggle="dropdown"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> <?php echo $LANG['menu']['updates']?><span class="caret"></span></a>
                <ul class="dropdown-menu">
            ...
            <li><a href="#" data-toggle="dropdown"><span class="glyphicon glyphicon-wrench" aria-hidden="true"></span> <?php echo $LANG['menu']['utilities']?><span class="caret"></span></a>
                <ul  class="dropdown-menu">
            ...
            <li><a href="#" data-toggle="dropdown"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> <?php echo $LANG['menu']['configuration']?><span class="caret"></span></a>
                <ul class="dropdown-menu">
            ...
            <li><a href="#" data-toggle="dropdown"><span class="glyphicon glyphicon-question-sign" aria-hidden="true"></span> <?php echo $LANG['menu']['help']?><span class="caret"></a>
                <ul class="dropdown-menu">
            ...
            <li><a href="javascript:Ajax('wallpapers/sair', 'conteudo', '')"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span> <?php echo $LANG['menu']['logout']?></a></li>
            <li><div id="saudacao"></div></li>
        </ul>
