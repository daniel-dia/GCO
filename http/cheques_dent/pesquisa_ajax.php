...
?>
    <tr bgcolor="#<?php echo $odev?>" onmouseout="style.background='#<?php echo $odev?>'" onmouseover="style.background='#DDE1E6'">
      ...
      <td width="66" align="center"><?php echo ((verifica_nivel('cheques', 'V'))?'<a href="javascript:;" onclick="javascript:Ajax(\'cheques_dent/incluir\', \'conteudo\', \'codigo='.$cheque->RetornaDados('codigo').'&acao=editar\')"><img src="imagens/icones/editar.png" alt="Editar" width="16" height="18" border="0"></a>':'')?></td>
      <td width="66" align="center"><?php echo ((verifica_nivel('cheques', 'E'))?'<a href="javascript:Ajax(\'cheques_dent/gerenciar\', \'conteudo\', \'codigo='.$cheque->RetornaDados('codigo').'" onclick="return confirmLink(this)"><img src="imagens/icones/excluir.png" alt="Excluir" width="19" height="19" border="0"></a>':'')?></td>
    </tr>
<?php
	}
?>
