...
?>
    <tr bgcolor="#<?php echo $odev?>" onmouseout="style.background='#<?php echo $odev?>'" onmouseover="style.background='#DDE1E6'">
      ...
      <td width="10%" align="center"><?php echo ((verifica_nivel('estoque', 'A'))?'<a href="javascript:Ajax(\'estoque_dent/extrato\', \'conteudo\', \'codigo='.$conta->RetornaDados('codigo').'" onclick="return confirmLink(this)"><img src="imagens/icones/excluir.png" alt="Excluir" width="19" height="19" border="0"></a>':'')?></td>
    </tr>
<?php
	}
	if($odev == $impar) {
...
?>
      ...
      <td width="140" align="right"><img src="imagens/icones/imprimir.png" border="0"> <a href="relatorios/estoque_dent.php?sql=<?php echo $sql?>" target="_blank"><?php echo $LANG['stock']['print_report']?></a></td>
    </tr>
  </table>
