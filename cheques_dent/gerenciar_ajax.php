...
<div class="conteudo" id="conteudo_central">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="conteudo">
    <tr>
      <td width="46%">&nbsp;&nbsp;&nbsp;<img src="cheques_dent/img/cheques.png" alt="<?php echo $LANG['check_control']['professional_check_control']?>"> <span class="h3"><?php echo $LANG['check_control']['professional_check_control']?></span></td>
      <td width="27%" valign="bottom">
        <table width="100%" border="0">
      	  <tr>
      	    <td>
      	      <?php echo $LANG['check_control']['search_for']?><br>
      ...
      <td width="23%" align="right" valign="bottom"><?php echo ((verifica_nivel('cheques', 'I'))?'<img src="imagens/icones/novo.gif" alt="" width="19" height="22" border="0"><a href="javascript:Ajax(\'cheques_dent/incluir\', \'conteudo\', \'codigo_dentista='.$_SESSION[codigo].'\')">'.$LANG['check_control']['include_new_check'].'</a>':'')?></td>
...
<div class="conteudo" id="table dados"><br>
  ...
  <div id="pesquisa"></div>
  <script>
  Ajax('cheques_dent/pesquisa', 'pesquisa', 'codigo_dentista=<?php echo $_SESSION[codigo]?>&pesquisa=&campo=nometitular');
  </script>
</div>
