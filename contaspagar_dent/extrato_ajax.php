<?php
    ...
    */
	...
	if($_GET[confirm_del] == "delete") {
		mysql_query("DELETE FROM `contaspagar_dent` WHERE `codigo` = '".$_GET[codigo]."'") or die(mysql_error());
	}
...
<div class="conteudo" id="conteudo_central">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="conteudo">
    <tr>
      <td width="46%">&nbsp;&nbsp;&nbsp;<img src="contaspagar_dent/img/contas.png" alt="<?php echo $LANG['accounts_payable']['professional_accounts_payable']?>"> <span class="h3"><?php echo $LANG['accounts_payable']['professional_accounts_payable']?> </span></td>
	  ...
	  <?php echo $LANG['accounts_payable']['search_for']?> <input name="procurar" id="procurar" type="text" class="forms" size="20" maxlength="40" onkeyup="javascript:Ajax('contaspagar_dent/pesquisa', 'pesquisa', 'pesquisa='%2Bthis.value%2B'&peri='%2Bdocument.getElementById('peri').value%2B'&codigo_dentista=<?php echo $_SESSION[codigo]?>')"
	  ...
	  <br>
      <input type="radio" name="pesq" id="pesqmesatual" checked="checked" value="mesatual" onclick="javascript:Ajax('contaspagar_dent/pesquisa', 'pesquisa', 'peri=mesatual')"><label for="pesqmesatual"> <?php echo $LANG['accounts_payable']['current_month']?></label>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</td>
...
?>
  <form id="form2" name="form2" method="POST" action="contaspagar_dent/extrato_ajax.php" onsubmit="formSender(this, 'conteudo'); this.reset(); return false;">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="conteudo">
    <tr>
      <td width="4%">
      </td>
...
<div class="conteudo" id="table dados"><br>
  ...
  <div id="pesquisa"></div>
  <script>
  Ajax('contaspagar_dent/pesquisa', 'pesquisa', 'codigo_dentista=<?php echo $_SESSION[codigo]?>&pesquisa=');
  </script>
</div>
